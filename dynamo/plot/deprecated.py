...
from .scatters import map_to_points
from .utils import (
    _datashade_points,
...
@deprecated
def plot_direct_graph(*args, **kwargs):
    return _plot_direct_graph_legacy(*args, **kwargs)


def _plot_direct_graph_legacy(
    adata: AnnData,
    layout: None = None,
...
@deprecated
def scatters_legacy(*args, **kwargs):
    return _scatters_legacy(*args, **kwargs)


def _scatters_legacy(
    adata: AnnData,
    basis: str = "umap",
    x: int = 0,
    y: int = 1,
...
def scatters_interactive_legacy(*args, **kwargs):
    return _scatters_interactive_legacy(*args, **kwargs)


def _scatters_interactive_legacy(
    adata: AnnData,
    basis: str = "umap",
    x: Union[int, str] = 0,
    y: Union[int, str] = 1,
